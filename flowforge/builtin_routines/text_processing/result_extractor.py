...
class ExtractorProtocol(Protocol):
    ...
    def extract(self, data: Any, config: Dict[str, Any]) -> Optional[Tuple[Any, str, Dict[str, Any]]]:
...
class ResultExtractor(Routine):
    ...
    def _get_extractor_order(self) -> List[Tuple[str, Callable]]:
        ...
        if priority:
            ...
            specialized = ["interpreter_output", "json_code_block", "json_string", 
                          "yaml_code_block", "yaml_string", "xml_code_block", "code_block"]
    ...
    def _extract_json_code_block(self, data: Any, config: Dict[str, Any]) -> Optional[Tuple[Any, str, Dict[str, Any]]]:
    ...
    def _extract_json_string(self, data: Any, config: Dict[str, Any]) -> Optional[Tuple[Any, str, Dict[str, Any]]]:
    ...
    def _extract_code_block(self, data: Any, config: Dict[str, Any]) -> Optional[Tuple[Any, str, Dict[str, Any]]]:
        ...
        for lang in languages:
            ...
            if blocks:
                return blocks[-1], lang, {
                    "extraction_method": f"{lang}_code_block",
                    "block_count": len(blocks)
                }
        
        return None
    
    def _extract_yaml_code_block(self, data: Any, config: Dict[str, Any]) -> Optional[Tuple[Any, str, Dict[str, Any]]]:
        ...
        for block in reversed(blocks):
            try:
                ...
                return result, "yaml", {
                    "extraction_method": "yaml_code_block",
                    "block_count": len(blocks)
                }
            except Exception:
                continue
    ...
    def _extract_yaml_string(self, data: Any, config: Dict[str, Any]) -> Optional[Tuple[Any, str, Dict[str, Any]]]:
    ...
    def _extract_xml_code_block(self, data: Any, config: Dict[str, Any]) -> Optional[Tuple[Any, str, Dict[str, Any]]]:
        ...
        return blocks[-1], "xml", {
            "extraction_method": "xml_code_block",
            "block_count": len(blocks)
        }
    
    def _format_interpreter_output(self, data: Any, config: Dict[str, Any]) -> Optional[Tuple[Any, str, Dict[str, Any]]]:
        ...
        if has_interpreter_structure and lines:
            formatted_text = "\n".join(lines)
            return formatted_text, "interpreter_output", {
    ...
    def _extract_dict(self, data: Any, config: Dict[str, Any]) -> Optional[Tuple[Any, str, Dict[str, Any]]]:
    ...
    def _extract_list(self, data: Any, config: Dict[str, Any]) -> Optional[Tuple[Any, str, Dict[str, Any]]]:
        """Extract from list."""
    ...
    def register_extractor(self, name: str, extractor: Callable[[Any, Dict[str, Any]], Optional[Tuple[Any, str, Dict[str, Any]]]]) -> None:
