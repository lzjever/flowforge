...
class DataFlattener(Routine):
    ...
    def __init__(self):
        ...
        # Define output event
        self.output_event = self.define_event("output", ["flattened_data", "original_type", "depth"])
    ...
    def _flatten(self, value: Any, prefix: str = "", depth: int = 0, visited: Optional[set] = None) -> Tuple[Dict[str, Any], str, int]:
