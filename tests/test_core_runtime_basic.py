...
class TestRuntimePost:
    ...
    def test_post_creates_job(self):
        ...
        worker_state, job = runtime.post("test_flow", "processor", "input", {"data": "test"})
    ...
    def test_post_with_metadata(self):
        ...
        worker_state, job = runtime.post(
            "test_flow", "processor", "input", {"data": "test"}, metadata=metadata
        )
    ...
    def test_post_with_custom_job_id(self):
        ...
        worker_state, job = runtime.post(
            "test_flow", "processor", "input", {"data": "test"}, job_id=custom_job_id
        )
