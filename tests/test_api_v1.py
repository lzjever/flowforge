...
class TestWorkerEndpoints:
    ...
    def test_create_worker(self, client, sample_flow):
        ...
        response = client.post("/api/v1/workers", json={"flow_id": "test_flow_v1"})
    ...
    def test_create_worker_flow_not_found(self, client):
        ...
        response = client.post("/api/v1/workers", json={"flow_id": "nonexistent_flow"})
    ...
    def test_get_worker(self, client, sample_flow):
        ...
        # Create worker first
        create_response = client.post("/api/v1/workers", json={"flow_id": "test_flow_v1"})
    ...
    def test_list_workers_with_filters(self, client, sample_flow):
        ...
        client.post("/api/v1/workers", json={"flow_id": "test_flow_v1"}).json()
...
class TestJobEndpoints:
    ...
    def test_fail_job(self, client, sample_flow):
        ...
        # Fail job
        response = client.post(f"/api/v1/jobs/{job_id}/fail", json={"error": "Test error"})
        assert response.status_code == 200
    ...
    def test_fail_job_not_found(self, client):
        ...
        response = client.post("/api/v1/jobs/nonexistent/fail", json={"error": "Test"})
        assert response.status_code == 404
...
class TestConcurrentOperations:
    ...
    def test_concurrent_worker_creation(self, client, sample_flow):
        ...
        def create_worker():
            return client.post("/api/v1/workers", json={"flow_id": "test_flow_v1"})
...
class TestWorkerLifecycle:
    ...
    def test_worker_lifecycle(self, client, sample_flow):
        ...
        # Create
        worker_id = client.post("/api/v1/workers", json={"flow_id": "test_flow_v1"}).json()[
            "worker_id"
        ]
