...
class WorkflowAnalyzer:
    ...
    def to_d2_format(self, data: Dict[str, Any], mode: str = "standard", 
                     routine_analysis: Optional[Union[str, Path, Dict[str, Any]]] = None) -> str:
    ...
    def _to_d2_format_ultimate(self, data: Dict[str, Any], 
                               routine_analysis: Optional[Union[str, Path, Dict[str, Any]]] = None) -> str:
    ...
    def _load_routine_analysis(self, routine_analysis: Optional[Union[str, Path, Dict[str, Any]]]) -> Optional[Dict[str, Any]]:
    ...
    def _get_enhanced_routine_info(self, routine: Dict[str, Any], 
                                   routine_analysis_data: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
    ...
    def _format_ultimate_routine_node(self, routine: Dict[str, Any], 
    ...
    def _format_dependency_section(self, dependency_graph: Dict[str, List[str]], 
                                  entry_points: set) -> List[str]:
    ...
    def save_d2(self, data: Dict[str, Any], output_path: Union[str, Path], 
                mode: str = "standard", 
                routine_analysis: Optional[Union[str, Path, Dict[str, Any]]] = None) -> None:
